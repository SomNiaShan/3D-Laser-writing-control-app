classdef UiPolicyController < handle
    ...
    methods
        ...
        function syncControlEnableStates(obj)
            ...
            planPrepared = ~isempty(obj.Model.PreparedPlan);
            planReady = planPrepared && ~obj.Model.TrajectoryInputsDirty;
            trajectoryReady = planReady && ...
                isfield(obj.Model.PreparedPlan, 'trajectory');
            pointUsesPlanTiming = trajectoryReady && ...
                trajectoryHasPerPointTiming(obj.Model.PreparedPlan.trajectory);
            isImported = obj.Ports.trajectory.selectedSourceMode() == "Imported Points";
            isZSweepSource = obj.Ports.trajectory.selectedSourceMode() == "Z Sweep";
            isZSweepMatrixEnabled = isZSweepSource && ...
                obj.Model.Ui.ZSweepMatrixCheckBox.Value;
            ...
            setEnable(obj.Model.Ui.ZSweepRadio, configurationUnlocked);
            setEnable({obj.Model.Ui.InputFileField, obj.Model.Ui.ColumnXField, obj.Model.Ui.ColumnYField, obj.Model.Ui.ColumnZField, ...
                obj.Model.Ui.ColumnPField, obj.Model.Ui.StartXField, obj.Model.Ui.StartYField, ...
                obj.Model.Ui.StartZField, obj.Model.Ui.MagnificationXField, obj.Model.Ui.MagnificationYField, ...
                obj.Model.Ui.MagnificationZField, obj.Model.Ui.EnableZCompensationCheckBox}, ...
                configurationUnlocked && ~isZSweepSource);
            setEnable(obj.Model.Ui.UseFixedPowerCheckBox, configurationUnlocked && isImported);
            setEnable(obj.Model.Ui.PlanPowerField, configurationUnlocked && ...
                (~isImported || obj.Model.Ui.UseFixedPowerCheckBox.Value));
            ...
            setEnable(obj.Model.Ui.ZSweepUseCurrentButton, ...
                stagesConnected && configurationUnlocked && isZSweepSource);
            setEnable({obj.Model.Ui.PointExposureLabel, obj.Model.Ui.PointExposureField, obj.Model.Ui.PointPauseLabel, obj.Model.Ui.PointPauseField}, ...
                configurationUnlocked && ~isZSweepSource && ~pointUsesPlanTiming);
            ...
            setEnable({obj.Model.Ui.ZSweepDirectionLabel, obj.Model.Ui.ZSweepDirectionDropDown, ...
                ...
                configurationUnlocked && isZSweepSource);
            setEnable(obj.Model.Ui.ZSweepMatrixCheckBox, ...
                configurationUnlocked && isZSweepSource);
            obj.Ports.trajectory.updateZSweepMatrixParameterEnableStates( ...
                isZSweepMatrixEnabled);
            ...
            setEnable([obj.Model.Ui.JogXMinusButton, obj.Model.Ui.JogXPlusButton, obj.Model.Ui.JogYMinusButton, ...
                ...
                manualStageEnabled);
            setEnable({obj.Model.Ui.LaserPowerField, obj.Model.Ui.ApplyManualPowerButton, ...
                obj.Model.Ui.LaserOnButton, obj.Model.Ui.LaserOffButton, ...
                obj.Model.Ui.FireExposureButton, obj.Model.Ui.FireStreamExposureButton}, ...
            ...
            setEnable(obj.Model.Ui.GoToFirstPointButton, ...
                trajectoryReady && stagesConnected && configurationUnlocked);
            setEnable(obj.Model.Ui.CheckBoundsButton, ...
                trajectoryReady && configurationUnlocked);
            setEnable(obj.Model.Ui.StartRunButton, planReady && ...
                stagesConnected && daqConnected && configurationUnlocked);
            ...
            obj.Ports.run.syncPauseResumeButton();
