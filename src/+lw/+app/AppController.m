    ...
    methods (Access = private)
        ...
        function buildControlTab(obj, tab)
            ...
            callbacks = struct( ...
                ...
                'applyManualPower', @stageLaser.onApplyManualPower, ...
                ...
                'fireStreamExposure', @stageLaser.onFireStreamExposure);
        ...
        function buildTrajectoryTab(obj, tab)
            ...
            callbacks = struct( ...
                ...
                'planInputChanged', @trajectory.onPlanInputChanged, ...
                'fixedPowerOverrideChanged', @trajectory.onFixedPowerOverrideChanged, ...
            ...
            trajectoryUi = lw_build_trajectory_tab( ...
                tab, callbacks, obj.uiBuildHelpers(), options);
        ...
        function buildRunTab(obj, tab)
            ...
            runUi = lw_build_run_tab(tab, callbacks, obj.uiBuildHelpers());
            obj.mergeUi(runUi);
        end
