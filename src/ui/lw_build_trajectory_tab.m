...
trajectoryUi.PlanPowerLabel = helpers.createRightLabel(sourceGrid, 'Power (%)', 8, 1);
trajectoryUi.UseFixedPowerCheckBox = uicheckbox(sourceGrid, ...
    'Text', 'Use Fixed Power (%)', ...
    'ValueChangedFcn', callbacks.fixedPowerOverrideChanged);
trajectoryUi.UseFixedPowerCheckBox.Layout.Row = 8;
trajectoryUi.UseFixedPowerCheckBox.Layout.Column = 1;
...
trajectoryUi.PlanPowerField.Tooltip = 'Fixed execution power used for every imported operation when enabled';
